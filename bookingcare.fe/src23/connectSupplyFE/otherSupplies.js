...
export const doctorScheduleLangs = {
  ...
  noSchedule: 'doctor-schedule.noSchedule',
  clinicAddress: 'doctor-schedule.clinicAddress',
  price: 'doctor-schedule.price',
  insuranceType: 'doctor-schedule.insuranceType',
  booking: 'doctor-schedule.booking',
};
